...
kable(elasticity.matrix, col.names = c('Product 2','Product 3','Product 4','Product 6'), digits = 3)

kable(elasticity.matrix.all, col.names = c('Product 2','Product 3','Product 4','Product 6'), digits = 3)
```
